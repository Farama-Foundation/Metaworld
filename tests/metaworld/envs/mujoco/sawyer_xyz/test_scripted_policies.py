...
test_cases_latest_nonoise = [
    ...
    ['button-press-topdown-v2', SawyerButtonPressTopdownV2Policy(), .0, 1.],
    ['button-press-topdown-wall-v1', SawyerButtonPressTopdownWallV1Policy(), .0, 1.],
    ['button-press-topdown-wall-v2', SawyerButtonPressTopdownWallV2Policy(), .0, 1.],
    ...
    ['button-press-wall-v2', SawyerButtonPressWallV2Policy(), .0, 1.],
...
test_cases_latest_noisy = [
    ...
    ['button-press-topdown-wall-v2', SawyerButtonPressTopdownWallV2Policy(), .1, .99],
    ...
    ['button-press-wall-v2', SawyerButtonPressWallV2Policy(), .1, .95],
