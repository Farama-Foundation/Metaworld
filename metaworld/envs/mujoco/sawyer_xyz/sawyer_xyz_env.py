...
class SawyerXYZEnv(ArmEnv):
    ...
    @property
    def left_pad(self):
        return self.get_body_com("l_finger_tip")

    @property
    def right_pad(self):
        return self.get_body_com("r_finger_tip")
    ...
    def touching_object(self, object_geom_id):
        ...
        leftpad_geom_id = self.data.geom("l_fingerpad_g0").id
        rightpad_geom_id = self.data.geom("r_fingerpad_g0").id
