...
class SawyerStickPushV2Env(SawyerXYZEnv):
    ...
    def _get_obs(self):
        ...
        goalPos = self._state_goal
        flat_obs = np.concatenate((hand, stickPos, objPos, goalPos))
    ...
    def _get_obs_dict(self):
        return dict(
            ...
            state_achieved_goal=self.get_body_com('object').copy(),
        )
