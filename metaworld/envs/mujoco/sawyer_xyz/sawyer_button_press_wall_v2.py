...
class SawyerButtonPressWallEnvV2(SawyerXYZEnv):
    ...
    @property
    def model_name(self):
        return get_asset_full_path('sawyer_xyz/sawyer_button_press_wall.xml', True)
    ...
    def step(self, action):
        ...
        info = {'reachDist': reachDist, 'goalDist': pressDist, 'epRew': reward, 'pickRew':None, 'success': float(pressDist <= 0.03)}
        info['goal'] = self.goal
