...
class SawyerStickPullV2Env(SawyerXYZEnv):
    """
    Motivation for V2:
        V1 was very difficult to solve because the observation didn't say where
        to move (where to reach) after object was in control.
    Changelog from V1 to V2:
        - (7/5/20) Added a 3 element vector to the observation. This vector
    ...
    def _get_obs_dict(self):
        ...
        return dict(
            ...
            state_achieved_goal=self.data.site_xpos[
