...
from metaworld.envs.mujoco.utils.create_xml import create_object_xml, create_root_xml, clean_xml
from collections import OrderedDict
from metaworld.envs.mujoco.utils.interpolation import TwoPointCSpline
...
BASE_DIR = '/'.join(str.split(metaworld.__file__, '/')[:-2])
asset_base_path = BASE_DIR + '/metaworld/envs/assets/multi_object_sawyer_xyz/'
...
class MultiSawyerEnv(MultitaskEnv, SawyerXYZEnv):
    def __init__(self,
        ...
        obj_classname = None, block_height=0.02, block_width = 0.02,
