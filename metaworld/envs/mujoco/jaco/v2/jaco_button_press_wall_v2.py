...
class TrainButtonPressWallv2(JacoButtonPressWallEnvV2):
    tasks = None

    def __init__(self):
        JacoButtonPressWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressWallv2(JacoButtonPressWallEnvV2):
    tasks = None
