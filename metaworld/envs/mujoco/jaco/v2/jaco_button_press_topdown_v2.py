...
class TrainButtonPressTopdownv2(JacoButtonPressTopdownEnvV2):
    tasks = None

    def __init__(self):
        JacoButtonPressTopdownEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownv2(JacoButtonPressTopdownEnvV2):
    tasks = None
