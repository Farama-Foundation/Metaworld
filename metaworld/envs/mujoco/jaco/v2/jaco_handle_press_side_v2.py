...
class TrainHandlePressSidev2(JacoHandlePressSideEnvV2):
    tasks = None

    def __init__(self):
        JacoHandlePressSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePressSidev2(JacoHandlePressSideEnvV2):
    tasks = None
