...
class TrainButtonPressTopdownWallv2(JacoButtonPressTopdownWallEnvV2):
    tasks = None

    def __init__(self):
        JacoButtonPressTopdownWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownWallv2(JacoButtonPressTopdownWallEnvV2):
    tasks = None
