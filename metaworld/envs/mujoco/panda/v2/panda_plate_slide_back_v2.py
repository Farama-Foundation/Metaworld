...
class TrainPlateSlideBackv2(PandaPlateSlideBackEnvV2):
    tasks = None

    def __init__(self):
        PandaPlateSlideBackEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideBackv2(PandaPlateSlideBackEnvV2):
    tasks = None
