...
class TrainButtonPressTopdownWallv2(PandaButtonPressTopdownWallEnvV2):
    tasks = None

    def __init__(self):
        PandaButtonPressTopdownWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownWallv2(PandaButtonPressTopdownWallEnvV2):
    tasks = None
