...
class TrainPlateSlideBackSidev2(PandaPlateSlideBackSideEnvV2):
    tasks = None

    def __init__(self):
        PandaPlateSlideBackSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideBackSidev2(PandaPlateSlideBackSideEnvV2):
    tasks = None
