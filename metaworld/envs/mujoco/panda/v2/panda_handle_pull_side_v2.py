...
class TrainHandlePullSidev2(PandaHandlePullSideEnvV2):
    tasks = None

    def __init__(self):
        PandaHandlePullSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePullSidev2(PandaHandlePullSideEnvV2):
    tasks = None
