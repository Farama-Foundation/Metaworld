...
class PandaReachTopApproachEnvV2(PandaEnv):
    """PandaReachEnv.
...
class TrainReachGoalAsObjv2(PandaReachTopApproachEnvV2):
    tasks = None

    def __init__(self):
        PandaReachTopApproachEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestReachGoalAsObjv2(PandaReachTopApproachEnvV2):
    tasks = None
