...
class TrainPegInsertionSidev2(PandaPegInsertionSideEnvV2):
    tasks = None

    def __init__(self):
        PandaPegInsertionSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPegInsertionSidev2(PandaPegInsertionSideEnvV2):
    tasks = None
