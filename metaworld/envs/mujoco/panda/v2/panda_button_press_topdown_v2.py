...
class TrainButtonPressTopdownv2(PandaButtonPressTopdownEnvV2):
    tasks = None

    def __init__(self):
        PandaButtonPressTopdownEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownv2(PandaButtonPressTopdownEnvV2):
    tasks = None
