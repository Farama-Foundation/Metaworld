...
class PandaReachGoalAsObjEnvV2(PandaEnv):
    """PandaReachEnv.
...
class TrainReachGoalAsObjv2(PandaReachGoalAsObjEnvV2):
    tasks = None

    def __init__(self):
        PandaReachGoalAsObjEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestReachGoalAsObjv2(PandaReachGoalAsObjEnvV2):
    tasks = None
