...
ML1_TRAIN_TEST_ENVS = OrderedDict(
    (
        ...
        (
            ...
            OrderedDict(
                (
                    ("train", TrainButtonPressTopdownv2),
        ...
        (
            ...
            OrderedDict(
                (
                    ("train", TrainButtonPressTopdownWallv2),
        ...
        (
            ...
            OrderedDict(
                (
                    ("train", TrainPlateSlideBackSidev2),
