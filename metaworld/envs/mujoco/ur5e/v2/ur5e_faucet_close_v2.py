...
class UR5eFaucetCloseEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_faucet.xml")
...
class TrainFaucetClosev2(UR5eFaucetCloseEnvV2):
    tasks = None

    def __init__(self):
        UR5eFaucetCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestFaucetClosev2(UR5eFaucetCloseEnvV2):
    tasks = None
