...
class UR5ePegInsertionSideEnvV2(UR5eEnv):
    TARGET_RADIUS = 0.07
    """
    Motivation for V2:
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_peg_insertion_side.xml")
...
class TrainPegInsertionSidev2(UR5ePegInsertionSideEnvV2):
    tasks = None

    def __init__(self):
        UR5ePegInsertionSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPegInsertionSidev2(UR5ePegInsertionSideEnvV2):
    tasks = None
