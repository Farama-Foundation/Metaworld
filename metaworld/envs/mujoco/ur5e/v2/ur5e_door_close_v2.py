...
class UR5eDoorCloseEnvV2(UR5eEnv):
...
class TrainDoorClosev2(UR5eDoorCloseEnvV2):
    tasks = None

    def __init__(self):
        UR5eDoorCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorClosev2(UR5eDoorCloseEnvV2):
    tasks = None
