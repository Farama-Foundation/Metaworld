...
class UR5eCoffeePullEnvV2(UR5eEnv):
...
class TrainCoffeePullv2(UR5eCoffeePullEnvV2):
    tasks = None

    def __init__(self):
        UR5eCoffeePullEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestCoffeePullv2(UR5eCoffeePullEnvV2):
    tasks = None
