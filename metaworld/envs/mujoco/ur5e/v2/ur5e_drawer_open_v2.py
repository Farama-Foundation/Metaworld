...
class UR5eDrawerOpenEnvV2(UR5eEnv):
...
class TrainDrawerOpenv2(UR5eDrawerOpenEnvV2):
    tasks = None

    def __init__(self):
        UR5eDrawerOpenEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDrawerOpenv2(UR5eDrawerOpenEnvV2):
    tasks = None
