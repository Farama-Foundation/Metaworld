...
class UR5eHandInsertEnvV2(UR5eEnv):
    TARGET_RADIUS = 0.05
...
class TrainHandInsertv2(UR5eHandInsertEnvV2):
    tasks = None

    def __init__(self):
        UR5eHandInsertEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandInsertv2(UR5eHandInsertEnvV2):
    tasks = None
