...
class UR5eCoffeePushEnvV2(UR5eEnv):
...
class TrainCoffeePushv2(UR5eCoffeePushEnvV2):
    tasks = None

    def __init__(self):
        UR5eCoffeePushEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestCoffeePushv2(UR5eCoffeePushEnvV2):
    tasks = None
