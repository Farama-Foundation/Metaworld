...
class UR5eBinPickingEnvV2(UR5eEnv):
    """UR5eBinPickingEnv.

    Motivation for V2:
        V1 was often unsolvable because the cube could be located outside of
        the starting bin. It could even be near the base of the UR5e and out
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_bin_picking.xml")
...
class TrainBinPickingv2(UR5eBinPickingEnvV2):
    tasks = None

    def __init__(self):
        UR5eBinPickingEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestBinPickingv2(UR5eBinPickingEnvV2):
    tasks = None
