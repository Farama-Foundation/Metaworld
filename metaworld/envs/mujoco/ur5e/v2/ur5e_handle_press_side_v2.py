...
class UR5eHandlePressSideEnvV2(UR5eEnv):
    """UR5eHandlePressSideEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_handle_press_sideways.xml")
...
class TrainHandlePressSidev2(UR5eHandlePressSideEnvV2):
    tasks = None

    def __init__(self):
        UR5eHandlePressSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePressSidev2(UR5eHandlePressSideEnvV2):
    tasks = None
