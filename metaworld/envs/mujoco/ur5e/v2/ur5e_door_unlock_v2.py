...
class UR5eDoorUnlockEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_door_lock.xml")
...
class TrainDoorUnlockv2(UR5eDoorUnlockEnvV2):
    tasks = None

    def __init__(self):
        UR5eDoorUnlockEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorUnlockv2(UR5eDoorUnlockEnvV2):
    tasks = None
