...
class UR5eHandlePullEnvV2(UR5eEnv):
...
class TrainHandlePullv2(UR5eHandlePullEnvV2):
    tasks = None

    def __init__(self):
        UR5eHandlePullEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePullv2(UR5eHandlePullEnvV2):
    tasks = None
