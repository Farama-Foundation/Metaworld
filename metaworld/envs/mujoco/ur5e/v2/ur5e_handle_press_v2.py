...
class UR5eHandlePressEnvV2(UR5eEnv):
    TARGET_RADIUS = 0.02
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_handle_press.xml")
...
class TrainHandlePressv2(UR5eHandlePressEnvV2):
    tasks = None

    def __init__(self):
        UR5eHandlePressEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePressv2(UR5eHandlePressEnvV2):
    tasks = None
