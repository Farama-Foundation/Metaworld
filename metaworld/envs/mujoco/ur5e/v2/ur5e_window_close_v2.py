...
class UR5eWindowCloseEnvV2(UR5eEnv):
    """UR5eWindowCloseEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_window_horizontal.xml")
...
class TrainWindowClosev2(UR5eWindowCloseEnvV2):
    tasks = None

    def __init__(self):
        UR5eWindowCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestWindowClosev2(UR5eWindowCloseEnvV2):
    tasks = None
