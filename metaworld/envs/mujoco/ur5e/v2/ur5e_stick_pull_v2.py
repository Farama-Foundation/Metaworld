...
class UR5eStickPullEnvV2(UR5eEnv):
...
class TrainStickPullv2(UR5eStickPullEnvV2):
    tasks = None

    def __init__(self):
        UR5eStickPullEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestStickPullv2(UR5eStickPullEnvV2):
    tasks = None
