...
class UR5ePlateSlideSideEnvV2(UR5eEnv):
...
class TrainPlateSlideSidev2(UR5ePlateSlideSideEnvV2):
    tasks = None

    def __init__(self):
        UR5ePlateSlideSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideSidev2(UR5ePlateSlideSideEnvV2):
    tasks = None
