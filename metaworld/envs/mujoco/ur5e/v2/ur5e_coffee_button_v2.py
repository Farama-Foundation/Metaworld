...
class UR5eCoffeeButtonEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_coffee.xml")
...
class TrainCoffeeButtonv2(UR5eCoffeeButtonEnvV2):
    tasks = None

    def __init__(self):
        UR5eCoffeeButtonEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestCoffeeButtonv2(UR5eCoffeeButtonEnvV2):
    tasks = None
