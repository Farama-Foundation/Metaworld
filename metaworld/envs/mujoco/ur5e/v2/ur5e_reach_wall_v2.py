...
class UR5eReachWallEnvV2(UR5eEnv):
    """UR5eReachWallEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_reach_wall_v2.xml")
...
class TrainReachWallv2(UR5eReachWallEnvV2):
    tasks = None

    def __init__(self):
        UR5eReachWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestReachWallv2(UR5eReachWallEnvV2):
    tasks = None
