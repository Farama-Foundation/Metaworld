...
class UR5eBoxCloseEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_box.xml")
    ...
    def compute_reward(self, actions, obs):
        reward_grab = UR5eBoxCloseEnvV2._reward_grab_effort(actions)
        reward_quat = UR5eBoxCloseEnvV2._reward_quat(obs)
        reward_steps = UR5eBoxCloseEnvV2._reward_pos(obs, self._target_pos)
...
class TrainBoxClosev2(UR5eBoxCloseEnvV2):
    tasks = None

    def __init__(self):
        UR5eBoxCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestBoxClosev2(UR5eBoxCloseEnvV2):
    tasks = None
