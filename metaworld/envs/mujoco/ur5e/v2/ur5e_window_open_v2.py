...
class UR5eWindowOpenEnvV2(UR5eEnv):
    """UR5eWindowOpenEnv.
...
class TrainWindowOpenv2(UR5eWindowOpenEnvV2):
    tasks = None

    def __init__(self):
        UR5eWindowOpenEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestWindowOpenv2(UR5eWindowOpenEnvV2):
    tasks = None
