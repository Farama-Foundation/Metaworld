...
class UR5eButtonPressTopdownWallEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_button_press_topdown_wall.xml")
...
class TrainButtonPressTopdownWallv2(UR5eButtonPressTopdownWallEnvV2):
    tasks = None

    def __init__(self):
        UR5eButtonPressTopdownWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownWallv2(UR5eButtonPressTopdownWallEnvV2):
    tasks = None
