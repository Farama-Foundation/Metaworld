...
class UR5ePegUnplugSideEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_peg_unplug_side.xml")
...
class TrainPegUnplugSidev2(UR5ePegUnplugSideEnvV2):
    tasks = None

    def __init__(self):
        UR5ePegUnplugSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPegUnplugSidev2(UR5ePegUnplugSideEnvV2):
    tasks = None
