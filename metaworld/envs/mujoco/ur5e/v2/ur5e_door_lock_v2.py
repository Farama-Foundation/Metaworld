...
class UR5eDoorLockEnvV2(UR5eEnv):
...
class TrainDoorLockv2(UR5eDoorLockEnvV2):
    tasks = None

    def __init__(self):
        UR5eDoorLockEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorLockv2(UR5eDoorLockEnvV2):
    tasks = None
