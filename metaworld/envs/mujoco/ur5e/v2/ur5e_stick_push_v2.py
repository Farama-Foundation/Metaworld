...
class UR5eStickPushEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_stick_obj.xml")
...
class TrainStickPushv2(UR5eStickPushEnvV2):
    tasks = None

    def __init__(self):
        UR5eStickPushEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestStickPushv2(UR5eStickPushEnvV2):
    tasks = None
