...
class UR5ePickPlaceWallEnvV2(UR5eEnv):
    """UR5ePickPlaceWallEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_pick_place_wall_v2.xml")
...
class TrainPickPlaceWallv2(UR5ePickPlaceWallEnvV2):
    tasks = None

    def __init__(self):
        UR5ePickPlaceWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPickPlaceWallv2(UR5ePickPlaceWallEnvV2):
    tasks = None
