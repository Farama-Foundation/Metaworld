...
class UR5eDrawerCloseEnvV2(UR5eEnv):
    _TARGET_RADIUS = 0.04
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_drawer.xml")
...
class TrainDrawerClosev2(UR5eDrawerCloseEnvV2):
    tasks = None

    def __init__(self):
        UR5eDrawerCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDrawerClosev2(UR5eDrawerCloseEnvV2):
    tasks = None
