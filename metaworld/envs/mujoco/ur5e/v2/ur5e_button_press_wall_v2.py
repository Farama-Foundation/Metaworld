...
class UR5eButtonPressWallEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_button_press_wall.xml")
...
class TrainButtonPressWallv2(UR5eButtonPressWallEnvV2):
    tasks = None

    def __init__(self):
        UR5eButtonPressWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressWallv2(UR5eButtonPressWallEnvV2):
    tasks = None
