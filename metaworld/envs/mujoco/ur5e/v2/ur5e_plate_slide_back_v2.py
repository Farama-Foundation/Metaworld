...
class UR5ePlateSlideBackEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_plate_slide.xml")
...
class TrainPlateSlideBackv2(UR5ePlateSlideBackEnvV2):
    tasks = None

    def __init__(self):
        UR5ePlateSlideBackEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideBackv2(UR5ePlateSlideBackEnvV2):
    tasks = None
