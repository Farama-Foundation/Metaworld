...
class UR5eDoorEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_door_pull.xml")
    ...
    def compute_reward(self, actions, obs):
        ...
        reward_grab = UR5eDoorEnvV2._reward_grab_effort(actions)
        reward_steps = UR5eDoorEnvV2._reward_pos(obs, theta)
...
class TrainDoorOpenv2(UR5eDoorEnvV2):
    tasks = None

    def __init__(self):
        UR5eDoorEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorOpenv2(UR5eDoorEnvV2):
    tasks = None
