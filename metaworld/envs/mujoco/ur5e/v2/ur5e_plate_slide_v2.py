...
class UR5ePlateSlideEnvV2(UR5eEnv):
    OBJ_RADIUS = 0.04
...
class TrainPlateSlidev2(UR5ePlateSlideEnvV2):
    tasks = None

    def __init__(self):
        UR5ePlateSlideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlidev2(UR5ePlateSlideEnvV2):
    tasks = None
