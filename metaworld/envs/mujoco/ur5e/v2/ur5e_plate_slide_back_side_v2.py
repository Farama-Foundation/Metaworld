...
class UR5ePlateSlideBackSideEnvV2(UR5eEnv):
    """UR5ePlateSlideBackSideEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_plate_slide_sideway.xml")
...
class TrainPlateSlideBackSidev2(UR5ePlateSlideBackSideEnvV2):
    tasks = None

    def __init__(self):
        UR5ePlateSlideBackSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideBackSidev2(UR5ePlateSlideBackSideEnvV2):
    tasks = None
