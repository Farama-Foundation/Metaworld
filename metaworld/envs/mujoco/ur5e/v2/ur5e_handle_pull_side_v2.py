...
class UR5eHandlePullSideEnvV2(UR5eEnv):
...
class TrainHandlePullSidev2(UR5eHandlePullSideEnvV2):
    tasks = None

    def __init__(self):
        UR5eHandlePullSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePullSidev2(UR5eHandlePullSideEnvV2):
    tasks = None
