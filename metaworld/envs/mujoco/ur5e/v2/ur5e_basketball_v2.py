...
class UR5eBasketballEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_basketball.xml")
...
class TrainBasketballv2(UR5eBasketballEnvV2):
    tasks = None

    def __init__(self):
        UR5eBasketballEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestBasketballv2(UR5eBasketballEnvV2):
    tasks = None
