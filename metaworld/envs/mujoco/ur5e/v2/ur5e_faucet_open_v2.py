...
class UR5eFaucetOpenEnvV2(UR5eEnv):
...
class TrainFaucetOpenv2(UR5eFaucetOpenEnvV2):
    tasks = None

    def __init__(self):
        UR5eFaucetOpenEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestFaucetOpenv2(UR5eFaucetOpenEnvV2):
    tasks = None
