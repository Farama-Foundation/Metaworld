...
class UR5eDialTurnEnvV2(UR5eEnv):
    TARGET_RADIUS = 0.07
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_dial.xml")
...
class TrainDialTurnv2(UR5eDialTurnEnvV2):
    tasks = None

    def __init__(self):
        UR5eDialTurnEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDialTurnv2(UR5eDialTurnEnvV2):
    tasks = None
