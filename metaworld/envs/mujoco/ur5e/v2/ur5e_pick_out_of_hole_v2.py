...
class UR5ePickOutOfHoleEnvV2(UR5eEnv):
    _TARGET_RADIUS = 0.02
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_pick_out_of_hole.xml")
...
class TrainPickOutOfHolev2(UR5ePickOutOfHoleEnvV2):
    tasks = None

    def __init__(self):
        UR5ePickOutOfHoleEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPickOutOfHolev2(UR5ePickOutOfHoleEnvV2):
    tasks = None
