...
class UR5eButtonPressTopdownEnvV2(UR5eEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("ur5e/ur5e_button_press_topdown.xml")
...
class TrainButtonPressTopdownv2(UR5eButtonPressTopdownEnvV2):
    tasks = None

    def __init__(self):
        UR5eButtonPressTopdownEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownv2(UR5eButtonPressTopdownEnvV2):
    tasks = None
