...
class FetchDialTurnEnvV2(FetchEnv):
    TARGET_RADIUS = 0.07
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_dial.xml")
...
class TrainDialTurnv2(FetchDialTurnEnvV2):
    tasks = None

    def __init__(self):
        FetchDialTurnEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDialTurnv2(FetchDialTurnEnvV2):
    tasks = None
