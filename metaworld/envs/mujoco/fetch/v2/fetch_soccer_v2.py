...
class FetchSoccerEnvV2(FetchEnv):
    OBJ_RADIUS = 0.013
    TARGET_RADIUS = 0.07
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_soccer.xml")
...
class TrainSoccerv2(FetchSoccerEnvV2):
    tasks = None

    def __init__(self):
        FetchSoccerEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestSoccerv2(FetchSoccerEnvV2):
    tasks = None
