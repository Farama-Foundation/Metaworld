...
class FetchReachGoalAsObjEnvV2(FetchEnv):
    """FetchReachEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_reach_v2.xml")
...
class TrainReachGoalAsObjv2(FetchReachGoalAsObjEnvV2):
    tasks = None

    def __init__(self):
        FetchReachGoalAsObjEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestReachGoalAsObjv2(FetchReachGoalAsObjEnvV2):
    tasks = None
