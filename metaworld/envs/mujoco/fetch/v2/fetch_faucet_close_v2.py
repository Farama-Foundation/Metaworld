...
class FetchFaucetCloseEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_faucet.xml")
...
class TrainFaucetClosev2(FetchFaucetCloseEnvV2):
    tasks = None

    def __init__(self):
        FetchFaucetCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestFaucetClosev2(FetchFaucetCloseEnvV2):
    tasks = None
