...
class FetchFaucetOpenEnvV2(FetchEnv):
...
class TrainFaucetOpenv2(FetchFaucetOpenEnvV2):
    tasks = None

    def __init__(self):
        FetchFaucetOpenEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestFaucetOpenv2(FetchFaucetOpenEnvV2):
    tasks = None
