...
class FetchCoffeePushEnvV2(FetchEnv):
...
class TrainCoffeePushv2(FetchCoffeePushEnvV2):
    tasks = None

    def __init__(self):
        FetchCoffeePushEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestCoffeePushv2(FetchCoffeePushEnvV2):
    tasks = None
