...
class FetchPegUnplugSideEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_peg_unplug_side.xml")
...
class TrainPegUnplugSidev2(FetchPegUnplugSideEnvV2):
    tasks = None

    def __init__(self):
        FetchPegUnplugSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPegUnplugSidev2(FetchPegUnplugSideEnvV2):
    tasks = None
