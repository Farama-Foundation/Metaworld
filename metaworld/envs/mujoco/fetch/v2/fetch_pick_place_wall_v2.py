...
class FetchPickPlaceWallEnvV2(FetchEnv):
    """FetchPickPlaceWallEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_pick_place_wall_v2.xml")
...
class TrainPickPlaceWallv2(FetchPickPlaceWallEnvV2):
    tasks = None

    def __init__(self):
        FetchPickPlaceWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPickPlaceWallv2(FetchPickPlaceWallEnvV2):
    tasks = None
