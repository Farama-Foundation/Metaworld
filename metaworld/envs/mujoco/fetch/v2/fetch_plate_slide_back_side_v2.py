...
class FetchPlateSlideBackSideEnvV2(FetchEnv):
    """FetchPlateSlideBackSideEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_plate_slide_sideway.xml")
...
class TrainPlateSlideBackSidev2(FetchPlateSlideBackSideEnvV2):
    tasks = None

    def __init__(self):
        FetchPlateSlideBackSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideBackSidev2(FetchPlateSlideBackSideEnvV2):
    tasks = None
