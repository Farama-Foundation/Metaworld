...
class FetchCoffeeButtonEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_coffee.xml")
...
class TrainCoffeeButtonv2(FetchCoffeeButtonEnvV2):
    tasks = None

    def __init__(self):
        FetchCoffeeButtonEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestCoffeeButtonv2(FetchCoffeeButtonEnvV2):
    tasks = None
