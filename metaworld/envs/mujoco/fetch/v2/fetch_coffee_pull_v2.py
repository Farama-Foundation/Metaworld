...
class FetchCoffeePullEnvV2(FetchEnv):
...
class TrainCoffeePullv2(FetchCoffeePullEnvV2):
    tasks = None

    def __init__(self):
        FetchCoffeePullEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestCoffeePullv2(FetchCoffeePullEnvV2):
    tasks = None
