...
class FetchHandlePressSideEnvV2(FetchEnv):
    """FetchHandlePressSideEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_handle_press_sideways.xml")
...
class TrainHandlePressSidev2(FetchHandlePressSideEnvV2):
    tasks = None

    def __init__(self):
        FetchHandlePressSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePressSidev2(FetchHandlePressSideEnvV2):
    tasks = None
