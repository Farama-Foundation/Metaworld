...
class FetchButtonPressEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_button_press.xml")
...
class TrainButtonPressv2(FetchButtonPressEnvV2):
    tasks = None

    def __init__(self):
        FetchButtonPressEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressv2(FetchButtonPressEnvV2):
    tasks = None
