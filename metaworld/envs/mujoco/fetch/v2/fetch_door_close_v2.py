...
class FetchDoorCloseEnvV2(FetchEnv):
...
class TrainDoorClosev2(FetchDoorCloseEnvV2):
    tasks = None

    def __init__(self):
        FetchDoorCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorClosev2(FetchDoorCloseEnvV2):
    tasks = None
