...
class FetchPlateSlideSideEnvV2(FetchEnv):
...
class TrainPlateSlideSidev2(FetchPlateSlideSideEnvV2):
    tasks = None

    def __init__(self):
        FetchPlateSlideSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideSidev2(FetchPlateSlideSideEnvV2):
    tasks = None
