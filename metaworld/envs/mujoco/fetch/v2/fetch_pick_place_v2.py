...
class FetchPickPlaceEnvV2(FetchEnv):
    """FetchPickPlaceEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_pick_place_v2.xml")
...
class TrainPickPlacev2(FetchPickPlaceEnvV2):
    tasks = None

    def __init__(self):
        FetchPickPlaceEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPickPlacev2(FetchPickPlaceEnvV2):
    tasks = None
