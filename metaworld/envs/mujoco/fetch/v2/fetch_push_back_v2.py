...
class FetchPushBackEnvV2(FetchEnv):
    OBJ_RADIUS = 0.007
    TARGET_RADIUS = 0.05
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_push_back_v2.xml")
...
class TrainPushBackv2(FetchPushBackEnvV2):
    tasks = None

    def __init__(self):
        FetchPushBackEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPushBackv2(FetchPushBackEnvV2):
    tasks = None
