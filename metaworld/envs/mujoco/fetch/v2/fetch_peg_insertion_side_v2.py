...
class FetchPegInsertionSideEnvV2(FetchEnv):
    TARGET_RADIUS = 0.07
    """
    Motivation for V2:
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_peg_insertion_side.xml")
...
class TrainPegInsertionSidev2(FetchPegInsertionSideEnvV2):
    tasks = None

    def __init__(self):
        FetchPegInsertionSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPegInsertionSidev2(FetchPegInsertionSideEnvV2):
    tasks = None
