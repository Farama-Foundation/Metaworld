...
class FetchHandInsertEnvV2(FetchEnv):
    TARGET_RADIUS = 0.05
...
class TrainHandInsertv2(FetchHandInsertEnvV2):
    tasks = None

    def __init__(self):
        FetchHandInsertEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandInsertv2(FetchHandInsertEnvV2):
    tasks = None
