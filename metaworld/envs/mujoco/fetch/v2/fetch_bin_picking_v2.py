...
class FetchBinPickingEnvV2(FetchEnv):
    """FetchBinPickingEnv.

    Motivation for V2:
        V1 was often unsolvable because the cube could be located outside of
        the starting bin. It could even be near the base of the Fetch and out
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_bin_picking.xml")
...
class TrainBinPickingv2(FetchBinPickingEnvV2):
    tasks = None

    def __init__(self):
        FetchBinPickingEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestBinPickingv2(FetchBinPickingEnvV2):
    tasks = None
