...
class FetchPickOutOfHoleEnvV2(FetchEnv):
    _TARGET_RADIUS = 0.02
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_pick_out_of_hole.xml")
...
class TrainPickOutOfHolev2(FetchPickOutOfHoleEnvV2):
    tasks = None

    def __init__(self):
        FetchPickOutOfHoleEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPickOutOfHolev2(FetchPickOutOfHoleEnvV2):
    tasks = None
