...
class FetchPushEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_push_v2.xml")
...
class TrainPushv2(FetchPushEnvV2):
    tasks = None

    def __init__(self):
        FetchPushEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPushv2(FetchPushEnvV2):
    tasks = None
