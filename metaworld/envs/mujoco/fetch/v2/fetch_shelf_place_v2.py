...
class FetchShelfPlaceEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_shelf_placing.xml")
...
class TrainShelfPlacev2(FetchShelfPlaceEnvV2):
    tasks = None

    def __init__(self):
        FetchShelfPlaceEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestShelfPlacev2(FetchShelfPlaceEnvV2):
    tasks = None
