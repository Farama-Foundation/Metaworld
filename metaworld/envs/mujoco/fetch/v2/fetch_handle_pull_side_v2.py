...
class FetchHandlePullSideEnvV2(FetchEnv):
...
class TrainHandlePullSidev2(FetchHandlePullSideEnvV2):
    tasks = None

    def __init__(self):
        FetchHandlePullSideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePullSidev2(FetchHandlePullSideEnvV2):
    tasks = None
