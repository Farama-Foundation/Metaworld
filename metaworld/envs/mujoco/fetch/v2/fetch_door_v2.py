...
class FetchDoorEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_door_pull.xml")
    ...
    def compute_reward(self, actions, obs):
        ...
        reward_grab = FetchDoorEnvV2._reward_grab_effort(actions)
        reward_steps = FetchDoorEnvV2._reward_pos(obs, theta)
...
class TrainDoorOpenv2(FetchDoorEnvV2):
    tasks = None

    def __init__(self):
        FetchDoorEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorOpenv2(FetchDoorEnvV2):
    tasks = None
