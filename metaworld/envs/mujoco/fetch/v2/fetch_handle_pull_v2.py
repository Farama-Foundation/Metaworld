...
class FetchHandlePullEnvV2(FetchEnv):
...
class TrainHandlePullv2(FetchHandlePullEnvV2):
    tasks = None

    def __init__(self):
        FetchHandlePullEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePullv2(FetchHandlePullEnvV2):
    tasks = None
