...
class FetchHandlePressEnvV2(FetchEnv):
    TARGET_RADIUS = 0.02
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_handle_press.xml")
...
class TrainHandlePressv2(FetchHandlePressEnvV2):
    tasks = None

    def __init__(self):
        FetchHandlePressEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestHandlePressv2(FetchHandlePressEnvV2):
    tasks = None
