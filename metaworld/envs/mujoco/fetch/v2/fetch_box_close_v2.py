...
class FetchBoxCloseEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_box.xml")
    ...
    def compute_reward(self, actions, obs):
        reward_grab = FetchBoxCloseEnvV2._reward_grab_effort(actions)
        reward_quat = FetchBoxCloseEnvV2._reward_quat(obs)
        reward_steps = FetchBoxCloseEnvV2._reward_pos(obs, self._target_pos)
...
class TrainBoxClosev2(FetchBoxCloseEnvV2):
    tasks = None

    def __init__(self):
        FetchBoxCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestBoxClosev2(FetchBoxCloseEnvV2):
    tasks = None
