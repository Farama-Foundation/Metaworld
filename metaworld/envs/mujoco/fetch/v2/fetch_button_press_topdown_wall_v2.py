...
class FetchButtonPressTopdownWallEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_button_press_topdown_wall.xml")
...
class TrainButtonPressTopdownWallv2(FetchButtonPressTopdownWallEnvV2):
    tasks = None

    def __init__(self):
        FetchButtonPressTopdownWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownWallv2(FetchButtonPressTopdownWallEnvV2):
    tasks = None
