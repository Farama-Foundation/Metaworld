...
class FetchButtonPressWallEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_button_press_wall.xml")
...
class TrainButtonPressWallv2(FetchButtonPressWallEnvV2):
    tasks = None

    def __init__(self):
        FetchButtonPressWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressWallv2(FetchButtonPressWallEnvV2):
    tasks = None
