...
class FetchDrawerCloseEnvV2(FetchEnv):
    _TARGET_RADIUS = 0.04
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_drawer.xml")
...
class TrainDrawerClosev2(FetchDrawerCloseEnvV2):
    tasks = None

    def __init__(self):
        FetchDrawerCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDrawerClosev2(FetchDrawerCloseEnvV2):
    tasks = None
