...
class FetchReachWallEnvV2(FetchEnv):
    """FetchReachWallEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_reach_wall_v2.xml")
...
class TrainReachWallv2(FetchReachWallEnvV2):
    tasks = None

    def __init__(self):
        FetchReachWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestReachWallv2(FetchReachWallEnvV2):
    tasks = None
