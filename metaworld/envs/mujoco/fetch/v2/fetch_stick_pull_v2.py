...
class FetchStickPullEnvV2(FetchEnv):
...
class TrainStickPullv2(FetchStickPullEnvV2):
    tasks = None

    def __init__(self):
        FetchStickPullEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestStickPullv2(FetchStickPullEnvV2):
    tasks = None
