...
class FetchPushWallEnvV2(FetchEnv):
    """FetchPushEnvV2 updates FetchReachPushPickPlaceWallEnv.

    Env now handles only 'Push' task type from FetchReachPushPickPlaceWallEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_push_wall_v2.xml")
...
class TrainPushWallv2(FetchPushWallEnvV2):
    tasks = None

    def __init__(self):
        FetchPushWallEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPushWallv2(FetchPushWallEnvV2):
    tasks = None
