...
class FetchPlateSlideBackEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_plate_slide.xml")
...
class TrainPlateSlideBackv2(FetchPlateSlideBackEnvV2):
    tasks = None

    def __init__(self):
        FetchPlateSlideBackEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlideBackv2(FetchPlateSlideBackEnvV2):
    tasks = None
