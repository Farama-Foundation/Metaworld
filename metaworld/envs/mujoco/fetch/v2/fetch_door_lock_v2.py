...
class FetchDoorLockEnvV2(FetchEnv):
...
class TrainDoorLockv2(FetchDoorLockEnvV2):
    tasks = None

    def __init__(self):
        FetchDoorLockEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorLockv2(FetchDoorLockEnvV2):
    tasks = None
