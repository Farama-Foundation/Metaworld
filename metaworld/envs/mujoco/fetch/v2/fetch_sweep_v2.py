...
class FetchSweepEnvV2(FetchEnv):
    OBJ_RADIUS = 0.02
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_sweep_v2.xml")
...
class TrainSweepv2(FetchSweepEnvV2):
    tasks = None

    def __init__(self):
        FetchSweepEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestSweepv2(FetchSweepEnvV2):
    tasks = None
