...
class FetchButtonPressTopdownEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_button_press_topdown.xml")
...
class TrainButtonPressTopdownv2(FetchButtonPressTopdownEnvV2):
    tasks = None

    def __init__(self):
        FetchButtonPressTopdownEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestButtonPressTopdownv2(FetchButtonPressTopdownEnvV2):
    tasks = None
