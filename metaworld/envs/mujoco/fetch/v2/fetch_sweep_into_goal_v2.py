...
class FetchSweepIntoGoalEnvV2(FetchEnv):
    OBJ_RADIUS = 0.02
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_table_with_hole.xml")
...
class TrainSweepIntoGoalv2(FetchSweepIntoGoalEnvV2):
    tasks = None

    def __init__(self):
        FetchSweepIntoGoalEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestSweepIntoGoalv2(FetchSweepIntoGoalEnvV2):
    tasks = None
