...
class FetchStickPushEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_stick_obj.xml")
...
class TrainStickPushv2(FetchStickPushEnvV2):
    tasks = None

    def __init__(self):
        FetchStickPushEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestStickPushv2(FetchStickPushEnvV2):
    tasks = None
