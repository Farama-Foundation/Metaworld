...
class FetchWindowOpenEnvV2(FetchEnv):
    """FetchWindowOpenEnv.
...
class TrainWindowOpenv2(FetchWindowOpenEnvV2):
    tasks = None

    def __init__(self):
        FetchWindowOpenEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestWindowOpenv2(FetchWindowOpenEnvV2):
    tasks = None
