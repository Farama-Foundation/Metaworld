...
class FetchDoorUnlockEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_door_lock.xml")
...
class TrainDoorUnlockv2(FetchDoorUnlockEnvV2):
    tasks = None

    def __init__(self):
        FetchDoorUnlockEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestDoorUnlockv2(FetchDoorUnlockEnvV2):
    tasks = None
