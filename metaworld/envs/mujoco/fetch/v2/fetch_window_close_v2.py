...
class FetchWindowCloseEnvV2(FetchEnv):
    """FetchWindowCloseEnv.
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_window_horizontal.xml")
...
class TrainWindowClosev2(FetchWindowCloseEnvV2):
    tasks = None

    def __init__(self):
        FetchWindowCloseEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestWindowClosev2(FetchWindowCloseEnvV2):
    tasks = None
