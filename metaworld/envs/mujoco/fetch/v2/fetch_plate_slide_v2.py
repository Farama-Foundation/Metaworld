...
class FetchPlateSlideEnvV2(FetchEnv):
    OBJ_RADIUS = 0.04
...
class TrainPlateSlidev2(FetchPlateSlideEnvV2):
    tasks = None

    def __init__(self):
        FetchPlateSlideEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestPlateSlidev2(FetchPlateSlideEnvV2):
    tasks = None
