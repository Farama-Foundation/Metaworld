...
class FetchBasketballEnvV2(FetchEnv):
    ...
    @property
    def model_name(self):
        return full_v2_path_for("fetch/fetch_basketball.xml")
...
class TrainBasketballv2(FetchBasketballEnvV2):
    tasks = None

    def __init__(self):
        FetchBasketballEnvV2.__init__(self, self.tasks)

    def reset(self, seed=None, options=None):
        return super().reset(seed=seed, options=options)


class TestBasketballv2(FetchBasketballEnvV2):
    tasks = None
