...
class SawyerPushAndReachXYZEnvRemovedGoals(MultitaskEnv, SawyerXYZEnv):
    def __init__(
            self,
...
class SawyerPushAndReachXYEnvRemovedGoals(SawyerPushAndReachXYZEnvRemovedGoals):
    def __init__(self, *args, hand_z_position=0.02, **kwargs):
        self.quick_init(locals())
        SawyerPushAndReachXYZEnvRemovedGoals.__init__(self, *args, **kwargs)
...
class SawyerPushAndReachXYZEnvNoGoalMarkers(MultitaskEnv, SawyerXYZEnv):
    def __init__(
            self,
            reward_type='puck_distance',
            norm_order=2,
...
class SawyerPushAndReachXYEnvNoGoalMarkers(SawyerPushAndReachXYZEnvNoGoalMarkers):
    def __init__(self, *args, hand_z_position=0.02, **kwargs):
        self.quick_init(locals())
        SawyerPushAndReachXYZEnvNoGoalMarkers.__init__(self, *args, **kwargs)
        self.hand_z_position = hand_z_position
        self.action_space = Box(np.array([-1, -1]), np.array([1, 1]))
        self.fixed_goal[2] = hand_z_position
        hand_and_puck_low = self.hand_and_puck_space.low.copy()
...
class SawyerPushAndReachXYZEnvNoMocap(MultitaskEnv, SawyerXYZEnv):
    def __init__(
            self,
            reward_type='puck_distance',
            norm_order=2,
...
class SawyerPushAndReachXYEnvNoMocap(SawyerPushAndReachXYZEnvNoMocap):
    def __init__(self, *args, hand_z_position=0.02, **kwargs):
        self.quick_init(locals())
        SawyerPushAndReachXYZEnvNoMocap.__init__(self, *args, **kwargs)
        self.hand_z_position = hand_z_position
        self.action_space = Box(np.array([-1, -1]), np.array([1, 1]))
        self.fixed_goal[2] = hand_z_position
        hand_and_puck_low = self.hand_and_puck_space.low.copy()
